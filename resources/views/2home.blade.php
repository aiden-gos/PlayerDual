...
<x-app-layout>
   ...
   <script type="text/javascript" async=""
        src="https://www.gstatic.com/recaptcha/releases/DH3nyJMamEclyfe-nztbfV8S/recaptcha__en.js"
        crossorigin="anonymous" integrity="sha384-RFB9oVlvTplM2seWHBz+PsmThT1DmbvbuROpMMcARnCHL3Ko4+efpawFtv6DvE/q">
    </script>
    <script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script>
    <script type="text/javascript" async=""
        src="https://www.googletagmanager.com/gtag/js?id=G-GP9DV6E1SJ&amp;l=dataLayer&amp;cx=c"></script>
    <script type="text/javascript" async=""
        src="https://www.gstatic.com/recaptcha/releases/DH3nyJMamEclyfe-nztbfV8S/recaptcha__en.js"
        crossorigin="anonymous" integrity="sha384-RFB9oVlvTplM2seWHBz+PsmThT1DmbvbuROpMMcARnCHL3Ko4+efpawFtv6DvE/q">
    </script>
    ...
    @vite([
        'resources/home/font-awesome/css/all.css',
        'resources/home/static/css/6.cdb2c5fa.chunk.css',
        'resources/home/static/css/main.72efbd6f.chunk.css',
        'resources/home/static/js/3.f34aa057.chunk.js',
        'resources/home/static/js/11.cc3bddf3.chunk.js',
        'resources/home/static/css/0.19028fed.chunk.css',
        'resources/home/static/js/0.3cad61d3.chunk.js',
        'resources/home/static/css/2.10b93fc4.chunk.css',
        'resources/home/static/js/2.55f89b0d.chunk.js',
        'resources/home/static/css/12.72ee5233.chunk.css',
        'resources/home/static/js/12.dcd1dc9f.chunk.js',
        'resources/home/static/js/12.dcd1dc9f.chunk.js',
    ])
...
<body class="fixed-header">
                            ...
                            <li class="list-item ">
                                <div class="media">
                                    ...
                                    <div class="media-body media-middle">
                                        <p class="media-heading">Liên Minh Huyền Thoại</p>
                                    </div>
                                </div>
                            </li>
                            {{-- End game list  --}}
                ...
                <div class="home-flex-content">
                    <div class="slide banner carousel slide">
                        <div class="carousel-inner">
                            <div class="item"><a href="https://beelevelup.com" target="_blank"
                                    rel="noopener noreferrer"><img
                                        src="https://files.playerduo.net/production/images/banner/446982ba-1aeb-4730-8d52-8e4308776e4b__ca8ef380-0f15-11ee-a657-a54d6be1d46a__admin_banner.jpg"
                                        class="img-responsive" alt="banner"></a></div>
                            <div class="item active"><a href="https://www.facebook.com/groups/playerduovn"
                                    target="_blank" rel="noopener noreferrer"><img
                                        ...
                                        class="img-responsive" alt="banner"></a></div>
                        </div><a class="carousel-control left" role="button" href="#"><span
                                class="glyphicon glyphicon-chevron-left"></span><span
                                class="sr-only">Previous</span></a><a class="carousel-control right" role="button"
                            href="#"><span class="glyphicon glyphicon-chevron-right"></span><span
                            ...
                            <div data-testid="sliderList" class="styles-module_slider__o0fqa">
                                ...
                                <div class="action__box--list">
                                    <div class="box-item"><img
                                            src="https://files.playerduo.net/production/images/8aa7410d-7afa-4eae-9f26-ad949e20f806__c47fc230-85c6-11ee-bec4-f929e725acab__player_avatar.jpg"
                                            class="" alt="PD" id="avt-img-reponsiver">
                                        <div class="box-item-label">
                                            <p><i class="far fa-eye"></i> 15</p>
                                        </div>
                                    </div>
                                ...
                                <div class="action__box--list"><a href="/stories">
                                        <div class="box-item create">
                                            <div class="box-item-plus"><i class="fas fa-arrow-right"></i></div>
                                        </div>
                                        <p class="player-name">Xem thêm</p>
                                    </a></div>
                    ...
                    <div class="mobile-cate">
                        <div class="label-cate">
                            <p><span>Danh mục game</span></p><button type="button" class="btn btn-default"><i
                                    class="fal fa-search"></i></button>
                        </div>
                        <div class="list-group">
                            <ul class="scrolls">
                                {{-- game list mobile  --}}
                                <li class="list-item"><img alt="avatar game"
                                        src="https://playerduo.net/api/upload-service/game_avatars/715867c6-698f-411a-b4f9-1e9093130b60__f364f2e0-34ce-11ed-838c-b120e70abb59__game_avatars.jpg">
                                </li>
                                {{-- end game list mobile  --}}
                            </ul>
                        </div>
                    </div>
                    <div class="filter-player  hidden"><select class="form-control gender ">
                            <option value="">Giới tính</option>
                            <option value="female">Nữ</option>
                            <option value="male">Nam</option>
                        </select><select class="form-control type ">
                        ...
                        <div class="form-control online false">Online</div><button type="button"
                            class="form-control price false btn btn-default">Khoảng giá</button><input type="text"
                            class="form-control city" placeholder="Sống tại" readonly="" value=""><input type="text"
                            class="form-control name" placeholder="Tên/Url Player" autocomplete="off" maxlength="32"
                            value=""><input type="text" class="form-control category" placeholder="Tên game"
                            autocomplete="off" value=""><button type="button"
                            class="form-control btn-filter btn btn-default"><i class="fa fa-search"></i> Tìm
                            kiếm</button>
                    </div>
                    <div class="list-player">
                        <div class="box vip-player">
                            <header class="title-header vip">
                                <h5 class="title-header-left">VIP PLAYERS</h5>
                                <p class="title-header-right"><span>Làm mới</span><i class="fas fa-sync false"></i></p>
                            </header>
                            <div class="card-player row">
                                {{-- Card player  --}}
                                <div class="col-md-3">
                                    <div class="player-information-card-wrap">
                                        <div class="player-avatar"><a target="_blank" href="/thocuaanh"><img
                                                    src="https://files.playerduo.net/production/images/8aa7410d-7afa-4eae-9f26-ad949e20f806__c47fc230-85c6-11ee-bec4-f929e725acab__player_avatar.jpg"
                                                    class="" alt="PD" id="avt-img-reponsiver"></a><a target="_blank"
                                                class="player-price" href="/thocuaanh">100,000 đ/h</a></div><a
                                            target="_blank" class="player-information" href="/thocuaanh">
                                            <h3 class="player-name"><a target="_blank" href="/thocuaanh">Hexi quá ư là
                                                    cute</a>
                                                <div class="player-status ready"> </div>
                                            </h3>
                                            <p class="player-title">Giọng miền nammm</p>
                                            <div class="category">
                                                <div class="div--flex">
                                                    {{-- <div class="game-cate"><img
                                                            src="https://playerduo.net/api/upload-service/game_avatars/715867c6-698f-411a-b4f9-1e9093130b60__d8d57300-37bc-11ed-838c-b120e70abb59__game_avatars.jpg"
                                                            class="" alt="Khác"><img
                                                            src="https://playerduo.net/api/upload-service/game_avatars/715867c6-698f-411a-b4f9-1e9093130b60__95575640-37c4-11ed-838c-b120e70abb59__game_avatars.jpg"
                                                            class="" alt="Tâm Sự"><img
                                                            src="https://playerduo.net/api/upload-service/game_avatars/715867c6-698f-411a-b4f9-1e9093130b60__62295df0-34d5-11ed-838c-b120e70abb59__game_avatars.jpg"
                                                            class="" alt="GTA V"><img
                                                            src="https://playerduo.net/api/upload-service/game_avatars/715867c6-698f-411a-b4f9-1e9093130b60__f79153d0-33e4-11ed-838c-b120e70abb59__game_avatars.jpg"
                                                            class="" alt="Naraka Bladepoint">
                                                        <p>+4</p>
                                                    </div> --}}
                        ...
                        <div class="box hot-player">
                            <header class="title-header hot">
                                <h5 class="title-header-left">HOT PLAYERS</h5>
                                <p class="title-header-right"><span>Làm mới</span><i class="fas fa-sync false"></i></p>
                            </header>
                            <div class="card-player row">
                                {{-- Card Player --}}
                                <div class="col-md-3">
                                    <div class="player-information-card-wrap">
                                        <div class="player-avatar"><a target="_blank" href="/chanbaby95"><img
                                                    src="https://files.playerduo.net/production/images/8aa7410d-7afa-4eae-9f26-ad949e20f806__c47fc230-85c6-11ee-bec4-f929e725acab__player_avatar.jpg"
                                                    class="" alt="PD" id="avt-img-reponsiver"></a>
                                            <div class="sound-player pause"><i class="fas fa-play hidden"></i><audio
                                                    src="https://playerduo.net/api/upload-service/audio_voices/9db01e9c-110f-4a1f-a540-be5273c289a2__92a906f0-dada-11ed-a19f-23a3b10d190e__audio_voice.mp3"></audio>
                                                ...
                                                <div class="btn-play"><span class="time-text"
                                                        id="tracktime">14.3"</span><i class="fas fa-play"></i></div>
                                            </div><a target="_blank" class="player-price" href="/chanbaby95">100,000
                                                đ/h</a>
                                        </div><a target="_blank" class="player-information" href="/chanbaby95">
                                            <h3 class="player-name"><a target="_blank" href="/chanbaby95">Em bé Chan
                                                    ☁️❤️</a><i class="fas fa-check-circle kyc" aria-hidden="true"></i>
                                                <div class="player-status ready"> </div>
                                            </h3>
                                            <p class="player-title">Ước có bụt thuê bé 24h ❤️</p>
                                            <div class="category">
                                                <div class="div--flex">
                                                    {{-- <div class="game-cate"><img
                                                            src="https://playerduo.net/api/upload-service/game_avatars/715867c6-698f-411a-b4f9-1e9093130b60__95575640-37c4-11ed-838c-b120e70abb59__game_avatars.jpg"
                                                            class="" alt="Tâm Sự"><img
                                                            src="https://playerduo.net/api/upload-service/game_avatars/715867c6-698f-411a-b4f9-1e9093130b60__39932230-34cc-11ed-838c-b120e70abb59__game_avatars.jpg"
                                                            class="" alt="Free Fire"><img
                                                            src="https://playerduo.net/api/upload-service/game_avatars/715867c6-698f-411a-b4f9-1e9093130b60__3b5dac30-34d0-11ed-838c-b120e70abb59__game_avatars.jpg"
                                                            class="" alt="Liên Quân Mobile"><img
                                                            src="https://playerduo.net/api/upload-service/game_avatars/715867c6-698f-411a-b4f9-1e9093130b60__d8d57300-37bc-11ed-838c-b120e70abb59__game_avatars.jpg"
                                                            class="" alt="Xem Phim Chung">
                                                        <p>+5</p>
                                                    </div> --}}
                                                    <div class="rate"><i class="fas fa-star"></i>
                                                        <p>4.9 <i>(60)</i></p>
    ...
    <script src="./static/js/6.e2f4e853.chunk.js"></script>
    <script src="./static/js/main.cd2091fc.chunk.js"></script>
