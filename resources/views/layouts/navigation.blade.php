<nav x-data="{ open: false }" class="bg-gray-950/0 shadow-md shadow-gray-950/10 backdrop-blur-3xl z-[100]">
            ...
            @if (Route::has('login'))
                ...
                <x-dropdown align="right" width="72">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link class="flex flex-row items-center gap-2 border-b" href="/user/{{Auth::user()->id}}">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link class="flex flex-row items-center gap-2" :href="route('logout')"
                                ...
                                <svg width="28" height="28" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" class="icon">
