<div style="padding-bottom: 80px;">
        ...
        <br><br><br>
            <div class="mt-6 grid w-full grid-cols-2 justify-end space-x-4 md:flex">
                <button id="search-btn" class="h-10 active:scale-95 rounded-lg bg-rose-500 px-8 py-2 font-medium text-white outline-none focus:ring hover:opacity-90">Search</button>
            </div>
        </div>
  </div>
