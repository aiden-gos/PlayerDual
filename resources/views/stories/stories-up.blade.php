@auth
    <x-modal name="up-story-form" focusable>
        ...
        <form id="story" method="post" action="{{ route('donate') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                <x-input-label for="money" :value="__('Title')" />
                <x-text-input id="money" name="title" type="text" class="mt-1 block w-full" required autofocus
                    autocomplete="name" />
            </div>
            ...
            <div>
                ...
                <textarea class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full"
                    name="msg" id="msg" cols="65" rows="10"></textarea>
            </div>
