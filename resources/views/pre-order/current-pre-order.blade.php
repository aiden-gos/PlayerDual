                ...
                @if ($renting && !$rented)
                    ...
                    <div class="flex flex-row gap-5 justify-between w-full">
                        <div>
                            ...
                            <div id='time-rent'>{{ $renting->duration }} hour</div>
                        </div>
                ...
                @if ($rented && !$renting)
                    ...
                    <div class="flex flex-row gap-5">
                        <div>
                            ...
                            <div id='time-rent'>{{ $rented->duration }} hour</div>
                        </div>
                        <div id="countdown-pre-order" class="w-20 text-center content-center">00:00:00</div>
                        <div class="flex justify-center items-center">
                            <form method="post" action="{{ route('pre-order.end') }}">
                                @csrf
                                <input id="end-id" type="hidden" name="id" value="{{ $rented->id }}">
                                <x-primary-button class="ml-3">
                                    {{ __('Cancel') }}
                                </x-primary-button>
                            </form>
