    ...
    <div class="home-flex">
        <div class="home-flex-category">
            <div class="fixed-cate">
                <p class="mt-2"><span class="text-lg">Danh mục game</span></p>
                    ...
                    @foreach ($games as $game)
                        <div class="list-item">
                            <div class="flex flex-row gap-2 py-1 items-center">
                                ...
                                <p class="media-heading">{{ $game->name }}</p>
                            </div>
                        </div>
                    @endforeach
                    {{-- End game list  --}}
        ...
        <div class="home-flex-content" style="margin-top: 20px;">
            <div class="slide banner carousel slide">
                <div class="carousel-inner">
                    <div class="item"><a href="https://beelevelup.com" target="_blank" rel="noopener noreferrer"><img
                        ...
                        @foreach ($stories as $story)
                            <div class="action__box--list">
                                <div class="box-item"><video
                                        src="{{ $story->video_link }}"
                                        class="object-cover" alt="PD" id="avt-img-reponsiver">
                                ...
                                <div class="player-name">
                                    ...
                                    <p>{{isset($story->user->name) ? $story->user->name : ""}}</p>
                                </div>
                            </div>
            ...
            <div class="mobile-cate">
                ...
                <div class="list-group">
                    <ul class="scrolls">
                        {{-- game list mobile  --}}
                        @foreach ($games as $game)
                            <li class="list-item"><img alt="avatar game" src="{{ $game->avatar }}">
                            </li>
                        @endforeach
            ...
            <div class="filter-player  hidden"><select class="form-control gender ">
                ...
                <div class="form-control online false">Online</div><button type="button"
                    ...
                    class="form-control city" placeholder="Sống tại" readonly="" value=""><input
                    type="text" class="form-control name" placeholder="Tên/Url Player" autocomplete="off"
                    maxlength="32" value=""><input type="text" class="form-control category"
                    placeholder="Tên game" autocomplete="off" value=""><button type="button"
            ...
            <div class="list-player">
                <div class="box vip-player">
                    ...
                    <div class="card-player lg:flex lg:flex-row lg:flex-wrap">
                        {{-- Card player  --}}
                        @foreach ($vip_user as $player)
                            <div class="col-md-3">
                                <div class="player-information-card-wrap">
                                    <div class="player-avatar">
                                        <a target="_blank" href="/user/{{ $player->id }}">
                                            <img src="{{ $player->avatar }}" class="" alt="PD"
                                                id="avt-img-reponsiver"></a>
                                        <a target="_blank" class="player-price" href="/user/{{ $player->id }}">
                                            $ {{ $player->price }}</a>
                                    </div>
                                    <a target="_blank" class="px-2">
                                        <div class="player-name"><a target="_blank"
                                                href="/user/{{ $player->id }}">{{ $player->name }}</a>
                                        </div>
                            ...
                            <div class="player-information-card-wrap">
                                <div class="player-avatar"><a target="_blank" href="/chanbaby95"><img
                                    ...
                                    <div class="sound-player pause"><i class="fas fa-play hidden"></i><audio
                                        ...
                                        <div class="btn-play"><span class="time-text" id="tracktime">14.3"</span><i
